...
/** Move a collective to a new address. Only ever called before any mail has
 *  arrived, so there is nothing to forward: the old address simply stops
 *  existing and bounces. */
